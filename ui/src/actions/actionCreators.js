...
export function searchTerm(searchTerm, currentState) {
  return dispatch => {
    ...
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/explorer/search?term=${searchTerm}`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function getOverview(currentState) {
  return dispatch => {
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/explorer/overview`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function getSummary(currentState) {
  return dispatch => {
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/explorer/summary`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function getInterest(address, currentState) {
  return dispatch => {
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/kmd/interest?address=${address}`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function getUnspents(address, currentState) {
  return dispatch => {
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/kmd/listunspent?address=${address}`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function getPrices(currentState) {
  return dispatch => {
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/mm/prices`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function getOrderbooks(currentState) {
  return dispatch => {
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/mm/orderbook`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function fiatRates() {
  return dispatch => {
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/rates/kmd`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function coins(currentState) {
  return dispatch => {
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/mm/coins`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function stats(currentState) {
  return dispatch => {
    return fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/mm/stats`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function faucet(coin, address) {
  return new Promise((resolve, reject) => {
    fetch(`${config.https ? 'https' : 'http'}://${config.ip}:${config.port}/api/faucet?address=${address}&coin=${coin}`, {
      method: 'GET',
      headers: {
